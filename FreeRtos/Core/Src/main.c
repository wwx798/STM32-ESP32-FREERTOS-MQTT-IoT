...
{
    __HAL_TIM_SET_COMPARE(&htim2,TIM_CHANNEL_2,R);
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_2);  // 启动红色PWM
	HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_3);  // 启动绿色PWM
	HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_4);  // 启动蓝色PWM
